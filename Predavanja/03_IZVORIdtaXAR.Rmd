...
institute: Diplomski studij sociologije, FHS
font: 10pt
output:
...
- Web 
- Društvene mreže 
- Senzori i aplikacije  
- Upravljanje modernim podatcima
- Korištenje R za dohvat (modernih) izvora podataka
...
<br>
<br>
3. Aplikacije i senzorni uređaji
...
**Google trends:**
1. [Analizu prodaje kuća](https://rpubs.com/tonytusharjr/newhomes)
<br>
<br>
...
1. [Facebook](https://www.kaggle.com/chrisbow/an-introduction-to-facebook-ad-analysis-using-r) [+1](https://www.residualthoughts.com/2018/02/12/analyzing-facebook-messages-in-r/)
2. LinkedIn
3. Youtube
4. Instagram
5. Google+
