...
- za one koji žele znati više mogu biti korisni i sljedeći resursi: [vodič za tekstualnu analizu u R](http://eprints.lse.ac.uk/86659/1/Benoit_Text%20analysis%20in%20R_2018.pdf) koji se  i [kolegij za obradu prirodnog teksta](https://github.com/BrbanMiro/Analiza-teksta) u najstajnju koji sadrži i reference na mnoštvo korisnih resursa.
...
```{r dekriptivnoTxt, warning=F, message=F }
...
```{r dekriptivnoDom, warning=F,message=F}
