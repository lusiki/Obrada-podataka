...
— E.g. **Lubridate** paket za raad sa datumima i **rvest** paket za webscraping.
...
- Ozmi objek (mpg), napravi ovo (filter), nakon toga ovo (group by), etc.
...
- Verzija 1.0.0 ije bitna jer donosi stabilnu verziju paketa. Utrenutku pisanja ovih,aktualna verzija je 1.0.2. 
...
Kombiniranje `mutate` sa novim `across` dodatkom u dplyr 1.0.0+ omogućava jednostavan rad na selekciji varijabli. Primjerice:
...
- Prije ili kasnije možete očekivati ovu potrebu.
